...
function updateCardType(value, img) {
    ...
    document.getElementById("preview-type").innerHTML = typeLabel;
    ...
    switch(value) {
        ...
        case "token":
            ...
            reserve_cost.innerHTML = "";
            current_rarity = "commun";
            document.getElementById("preview-type").innerHTML = "Jeton Personnage";
            infos.innerHTML = "";
            break;
    }
...
function updateStats(stat, type) {
    if(type === "DELETE") {
        ...
        if(earth_stat < ocean_stat && earth_stat < leaf_stat) {
            modified["earth"] = true;
            smaller = true;
            document.getElementById("earth").innerHTML = '<img src="../images/earth_small.webp" alt="fond terre" height="35" id="earth-background"/>';
        } else if(ocean_stat < earth_stat && ocean_stat < leaf_stat) {
            modified["ocean"] = true;
            smaller = true;
            document.getElementById("ocean").innerHTML = '<img src="../images/ocean_small.webp" alt="fond océan" height="35" id="ocean-background"/>';
        } else if(leaf_stat < ocean_stat && leaf_stat < earth_stat) {
            modified["leaf"] = true;
            smaller = true;
            document.getElementById("leaf").innerHTML = '<img src="../images/leaf_small.webp" alt="fond feuille" height="35" id="leaf-background"/>';
        }
        //un plus grand
        if(smaller) {
            if(earth_stat > ocean_stat && earth_stat > leaf_stat) {
                modified["earth"] = true;
                document.getElementById("earth").innerHTML = '<img src="../images/earth_large_o.webp" alt="fond terre" height="35" id="earth-background"/>';
            } else if(ocean_stat > earth_stat && ocean_stat > leaf_stat) {
                modified["ocean"] = true;
                document.getElementById("ocean").innerHTML = '<img src="../images/ocean_large_o.webp" alt="fond océan" height="35" id="ocean-background"/>';
            } else if(leaf_stat > ocean_stat && leaf_stat > earth_stat) {
                modified["leaf"] = true;
                document.getElementById("leaf").innerHTML = '<img src="../images/leaf_large_o.webp" alt="fond feuille" height="35" id="leaf-background"/>';
            }
        } else {
            if(earth_stat > ocean_stat && earth_stat > leaf_stat) {
                modified["ocean"] = true;
        ...
        if(earth_stat === 0) {
            modified["earth"] = true;
            document.getElementById("earth").innerHTML = '<img src="../images/earth_zero.webp" alt="fond terre" height="35" id="earth-background"/>';
        }
        if(leaf_stat === 0) {
            modified["leaf"] = true;
            document.getElementById("leaf").innerHTML = '<img src="../images/leaf_zero.webp" alt="fond feuille" height="35" id="leaf-background"/>';
        }
        if(ocean_stat === 0) {
            modified["ocean"] = true;
            document.getElementById("ocean").innerHTML = '<img src="../images/ocean_zero.webp" alt="fond océan" height="35" id="ocean-background"/>';
        }
        //si aucune des conditions précédentes
        if(!modified["earth"])
            document.getElementById("earth").innerHTML = '<img src="../images/earth_normal.webp" alt="fond terre" height="35" id="earth-background"/>';
        if(!modified["leaf"])
            document.getElementById("leaf").innerHTML = '<img src="../images/leaf_normal.webp" alt="fond feuille" height="35" id="leaf-background"/>';
        if(!modified["ocean"])
            document.getElementById("ocean").innerHTML = '<img src="../images/ocean_normal.webp" alt="fond océan" height="35" id="ocean-background"/>';
...
function updateTokenType() {
    ...
    if(type === "landmark") {
        ...
        document.getElementById("preview-type").innerHTML = "Jeton Lieu";
...
function updateAdditionalType(text = "") {
    const cardTypeValue = document.getElementById("card-type").value;
    let typeLabel;
    ...
    switch (cardTypeValue) {
        ...
        case "token":
            ...
            break;
        default:
            typeLabel = cardTypeValue[0].toUpperCase() + cardTypeValue.substring(1);
            break;
    }

    if(cardTypeValue === "token") {
        if(document.getElementById("token-type")) {
            const tokenTypeValue = document.getElementById("token-type").value;
            let tokenLabel;
            switch (tokenTypeValue) {
                case "landmark":
                    ...
                    break;
                case "expedition":
                    tokenLabel = "Expédition";
                    break;
                default:
                    tokenLabel = tokenTypeValue[0].toUpperCase() + tokenTypeValue.substring(1);
                    break;
            }
            typeLabel += " " + tokenLabel;
        }
    }

    const value = document.getElementById("preview-type");
    if(text !== "")
        value.innerHTML = typeLabel + " - " + text;
    else 
        value.innerHTML = typeLabel;
}
